document.addEventListener("DOMContentLoaded", () => {
    ...
    const cargarUsuarios = async () => {
        try {
            tabla.innerHTML = "";
            const res = await fetch("https://sistemas.impuestosdurango.com/usuarios");
    ...
    document.getElementById("formEditar").addEventListener("submit", async (e) => {
        ...
        try {
            const res = await fetch(`https://sistemas.impuestosdurango.com/usuarios/${id}`, {
                method: "PUT",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify(data),
            });
    ...
    window.eliminar = async (id) => {
        ...
        try {
            const res = await fetch(`https://sistemas.impuestosdurango.com/usuarios/${id}`, { method: "DELETE" });
